...
function getHandler(options, proxy) {
  var corsAnywhere = {
    ...
    targetwhitelist: 'online.tableau.com/api' // requests not directed to a target containing this fragment will be blocked
  ...
  return function(req, res) {
    ...
    if (!location.host.includes(targetwhitelist)) {
      res.writeHead(403, 'Forbidden', cors_headers);
      res.end('The target "' + location.host + '" was not whitelisted by the operator of this proxy.');
      return;
    }
